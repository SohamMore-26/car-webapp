...
<head>
  <title>Carbook - Contact Us</title>
  <meta charset="utf-8">
...
<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $add = mysqli_query($con,"insert into contact(c_name , c_email , c_subject , c_message) values ('$name','$email','$subject','$message')") or die(mysqli_error($con));
        if($add)
        {
            echo "<script>";
